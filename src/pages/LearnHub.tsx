import { GraduationCap, PenTool, MessageCircle, Sparkles, Library, Headphones, Shuffle, Ear } from "lucide-react";
    ...
    <AppShell>
      ...
      <HubSection
        ...
        tiles={[
          ...
          {
            id: "sounds",
            label: "أصوات الإنجليزية",
            description: "الأصوات التي لا توجد في العربية، صوتاً بصوت",
            icon: Ear,
            to: "/sounds",
