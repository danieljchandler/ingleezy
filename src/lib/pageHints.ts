...
export const PAGE_HINTS: Record<string, { title: string; body: string; cta?: string }> = {
  ...
  meme: {
    title: "محلل الميمز",
    body: "ارفع أي ميم إنجليزي ونشرح لك النص والنكتة والإشارة الثقافية بالعامية — الميمز فيها أصعب إنجليزي بيمرّ عليك.",
  },
  "learn-from-x": {
    title: "تعلّم من X",
    body: "أدخل رابط منشور إنجليزي من X (تويتر). نستخرج النص ونفكّكه سطراً سطراً بالعامية، ونحوّل المفردات إلى بطاقات.",
  },
  "tutor-upload": {
    title: "رفع درس خصوصي",
