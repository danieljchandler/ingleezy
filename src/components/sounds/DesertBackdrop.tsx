  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-0 overflow-hidden dark:opacity-25">
      ...
      >
        ...
        <circle cx="320" cy="90" r="28" fill="#E8A93A" opacity="0.55" />
        <path
      ...
      >
        <defs>
          <linearGradient id="dune1" x1="0" y1="0" x2="0" y2="1">
            ...
            <stop offset="100%" stopColor="#8A3E80" />
          </linearGradient>
          <linearGradient id="water" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#6FB394" />
            <stop offset="100%" stopColor="#2E7D55" />
          </linearGradient>
        </defs>
        ...
        <g transform="translate(40,470)" opacity="0.75">
          ...
          <path d="M20,40 Q18,10 22,-30" stroke="#1F1420" strokeWidth="3" fill="none" strokeLinecap="round" />
          <path d="M55,40 Q60,5 56,-40" stroke="#1F1420" strokeWidth="3" fill="none" strokeLinecap="round" />
          ...
          <g transform="translate(56,-40)">
            {[20, 65, 110, 155, 200, 245, 290, 335].map((a) => (
              <path key={a} d="M0,0 Q16,-3 30,3" stroke="#2E7D55" strokeWidth="2.5" fill="none" strokeLinecap="round" transform={`rotate(${a})`} />
            ))}
          </g>
        </g>
      </svg>
      ...
      >
        ...
        <g transform="translate(290,640)" opacity="0.8">
          ...
          <path d="M15,20 Q12,-5 18,-35" stroke="#1F1420" strokeWidth="2.5" fill="none" strokeLinecap="round" />
